<?php //views/teacher/changepw
	...
	echo form_open('welcome/teacher/changepw',$formatts)."\n";
	
	echo '<div data-role="fieldcontain">'."\n";
	print form_label($this->lang->line('userlib_password'),'password');
    print form_password('password',NULL,'id="password" class="text required"');
    echo "</div>\n\n";

    echo '<div data-role="fieldcontain">'."\n";
    print form_label($this->lang->line('userlib_confirm_password'),'passconf');
    print form_password('passconf',NULL,'id="passconf" class="text required"');
    echo "</div>\n\n";     
