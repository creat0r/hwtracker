...
//jQuery MOBILE 
$config['asset'][] = array('file'=>'http://code.jquery.com/mobile/1.2.0/jquery.mobile-1.2.0.min.css','name'=>'jquerymobile120');
$config['asset'][] = array('file'=>'http://code.jquery.com/jquery-1.8.2.min.js','position'=>'header','name'=>'jquery-1.8.2.min');
//jquery mobile
$config['asset'][] = array('file'=>'http://code.jquery.com/mobile/1.2.0/jquery.mobile-1.2.0.min.js', 'needs'=>'jquery-1.8.2.min.js','position'=>'header','name'=>'jquery.mobile-1.2.0.min');
//jquery validaion for mobile
$config['asset'][] = array('file'=>'http://ajax.aspnetcdn.com/ajax/jquery.validate/1.7/jquery.validate.min.js', 'needs'=>'jquery-1.8.2.min.js','position'=>'header','name'=>'jquery.validate.min');
// css
$config['asset'][] = array('file'=>'mobilestyle.css');
// jQuery Mobile structure CSS use this with custom CSS
$config['asset'][] = array('file'=>'http://code.jquery.com/mobile/1.2.0/jquery.mobile.structure-1.2.0.min.css','name'=>'jquerystructurecss');
//custom CSS
$config['asset'][] = array('file'=>'notification_iOS.min.css','needs'=>'jquerystructurecss');

// datepicker for jquery mobile http://dev.jtsage.com/jQM-DateBox/demos/install.html
/*
...
*/
$config['asset'][] = array('file'=>'http://dev.jtsage.com/cdn/datebox/latest/jqm-datebox.min.css','name'=>'jqm-datebox.min');
$config['asset'][] = array('file'=>'http://dev.jtsage.com/cdn/datebox/latest/jqm-datebox.core.min.js','needs'=>'jquery.mobile-1.2.0.min','name'=>'jqm-datebox.core.min','position'=>'header');
$config['asset'][] = array('file'=>'http://dev.jtsage.com/cdn/datebox/latest/jqm-datebox.mode.calbox.min.js','needs'=>'jqm-datebox.core.min','name'=>'jqm-datebox.mode.calbox.min');
$config['asset'][] = array('file'=>'http://dev.jtsage.com/cdn/datebox/i18n/jquery.mobile.datebox.i18n.en_US.utf8.js','needs'=>'jqm-datebox.mode.calbox.min','name'=>'jquery.mobile.datebox.i18n','position'=>'header');

// Google chart since it is not js or css , this does not work. Add it in a template
//$config['asset'][] = array('file'=>'https://www.google.com/jsapi','name'=>'googlejsapi');
...
$config['asset_group']['PUBLIC'] = 'bep_front_layout|FlashStatus|jquery.mobile-1.2.0.min';
$config['asset_group']['ADMIN'] = 'reset|typography|bep_admin_layout|bep_admin_style|FlashStatus|forms|buttons|bep_navigation|treeview|bep_icons|bep_select_all';

// Added from here 
$config['asset_group']['SHOP'] = 'shopcustomtools|FlashStatus|webshop|shop.init|modernizr';
$config['asset_group']['SHOPADMIN'] = 'reset|typography|admin|site';
...
// asset group for jquery mobile
$config['asset_group']['MOBILE'] = "FlashStatus|jquerymobile120|jquery-1.8.2.min|jquery.mobile-1.2.0.min|jquery.validate.min|mobilestyle";
//$config['asset_group']['MOBILE'] = "FlashStatus|jquerystructurecss|notification_iOS.min|jquery-1.8.2.min|jquery.mobile-1.2.0.min|jquery.validate.min|mobilestyle";

$config['asset_group']['mobiledatepicker'] = "jqm-datebox.min|jqm-datebox.core.min|jqm-datebox.mode.calbox.min|jquery.mobile.datebox.i18n";
